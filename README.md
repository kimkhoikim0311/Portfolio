...
**Key Deliverables:**
- Business rules, functional and non-functional requirements
- Use case specification
- UML use case, activity, and sequence diagrams
- Entity relationship diagram (ERD)
- UAT test cases mapped to all functional requirements

👉 [View project](./beta-cinema/)
...
Before transitioning into Business Analysis, I worked as a UI/UX Designer on digital products across mobile and web platforms. A selection of my design shots is available on Dribbble.

👉 [View my design work on Dribbble](https://dribbble.com/NKK1103)
